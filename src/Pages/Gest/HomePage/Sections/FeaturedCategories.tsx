...
import { ColumnCusom, Divider, Title } from '../../../../Components/DeviderTitle/style'
...
let  obj:IObjFeaturedCategories={
    ...
    export const FeaturedCategories = (props: Props) => {
...
const getSlides = () => {
 const chunks: any = []
 Array(12).fill(obj).map((i:any, idx:number) => {
   if(idx % chunkSize === 0) {
     chunks.push([])
   }
          ...
          <Column style={{
            ...
            {Array(getSlides().length)
              ...
              .map((x, i) => (
               ...
               <Divider width={"200px"} height={"7px"} color="#FCDD06" style={{
                    marginTop:"22px"
               }} />
          </Column>
