...
export const CardItem = ({ _id, image, discount,name, price, rating, product, widthBorder = false }: PropsCardItem) => {
    return (
        <CardContainerWithoutLink widthBorder={true}>
            ...
            <ContainerCard to={`/product/${_id}`}>
                ...
                <Row JC="center" item="center">
                    ...
                    name="rate" edit={false} value={rating} size={50} />
                </Row>
                <RowPrice>
                    {discount && discount > 0 ? ( 
                     <> 
            ...
            <WrapperRow>
                <Row JC="center">
                    ...
                    <AddToCartButton to={`/product/${_id}`}>
                        Add to cart
                    </AddToCartButton>
                </Row>
            </WrapperRow>
